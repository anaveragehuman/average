...
DESCRIPTION="Context Runtime for AI Agents with CCP. 51 MCP tools, 10 read modes, 60+ compression patterns, cross-session memory (CCP), persistent AI knowledge with temporal facts + contradiction detection, multi-agent context sharing, LITM-aware positioning, AAAK compact format, adaptive compression with Thompson Sampling bandits. Supports 24+ AI tools. Reduces LLM token consumption by up to 99%."
HOMEPAGE="https://leanctx.com"
SRC_URI="
	https://github.com/yvgude/lean-ctx/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="cloud-server dev-tools +embeddings +http-server +jemalloc neural qdrant +secure-update team-server +tree-sitter"
S="${WORKDIR}/${P}/rust"
